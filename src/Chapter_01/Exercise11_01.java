...
public class Exercise11_01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The population for: ");
        System.out.println("year one = " + (int)((312_032_486 + 3600 * 24 * 365 * 
                (1.0 / 7 - 1.0 / 13 + 1.0 /45))));
        System.out.println("year one = " + (int)((312_032_486 + 3600 * 24 * 365 * 
                2 * (1.0 / 7 - 1.0 / 13 + 1.0 /45))));
        System.out.println("year one = " + (int)((312_032_486 + 3600 * 24 * 365 * 
                3 * (1.0 / 7 - 1.0 / 13 + 1.0 /45))));
        System.out.println("year one = " + (int)((312_032_486 + 3600 * 24 * 365 * 
                4 * (1.0 / 7 - 1.0 / 13 + 1.0 /45))));
        System.out.println("year one = " + (int)((312_032_486 + 3600 * 24 * 365 * 
                5 * (1.0 / 7 - 1.0 / 13 + 1.0 /45))));
    }
